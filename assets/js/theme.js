...
$(document).ready(function () {
    $(".player-slider .owl-carousel, .home-video .owl-carousel").owlCarousel({
        items: 1,
        dots: true,
        loop: true,
        margin: 30,
...
// Responsive Class Add
if ($(window).width() <= 1023) {
    $(".mb-view").addClass("offset-md-3");
}
...
(function ($) {
    ...
    $(window).load(function () {
        ...
        var header = document.getElementById("matchhead");
